...
//#define LOG2_WARP_SIZE 5U //original
//#define WARP_SIZE (1U << LOG2_WARP_SIZE) //original
...
extern "C" void initShuffledHistogram256(uint byteCount);
extern "C" void closeShuffledHistogram256(void);
